...
<div class="card p-4">
  ...
  <div class="col-md-4">
    ...
    <div class="input-group mb-4">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="file" class="form-control vehicle-image" accept="image/*" aria-label="Vehicle Image" name="vehicle_images[]" aria-describedby="basic-icon-default-vehicle-image">
    ...
    @if (isset($vehicleAnalysis['vehicle_image']))
                                <img src="{{ asset('storage/app/public/' . $vehicleAnalysis->vehicle_image) }}" class="img-fluid"
                                    alt="Vehicle Image" style="max-width: 35% !important;">
                            @endif
            </div>           
    </div>
